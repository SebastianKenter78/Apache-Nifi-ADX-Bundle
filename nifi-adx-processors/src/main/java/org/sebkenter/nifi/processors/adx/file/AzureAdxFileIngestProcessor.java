package org.sebkenter.nifi.processors.adx.file;
...
public class AzureAdxFileIngestProcessor extends AbstractProcessor {
    ...
    public static final PropertyDescriptor FILE_NAME = new PropertyDescriptor
            ...
            .description("The name of the file to read and send to ADX for ingestion.")
            .required(true)
